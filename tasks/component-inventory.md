...
- `drafts-tile__variants` / `__variant` (`--active`) — a média alján N szegmens a **betűkkel** (nem pöttyökkel): a scrub egyetlen kérdése az, hogy „melyiket nézem", és arra egy pötty nem válaszol.
- `drafts-tile__mc` — `MC404`, betű nélkül; `drafts-tile__matched` már **nem** sarok-badge, hanem a meta első sorában szöveg: `matched 18 (a,b)` — a szám az MC-hez tartozik, és hogy mely VARIÁNSOKRA érkezett anyag, azt egy sarok-badge sosem tudta elmondani.
