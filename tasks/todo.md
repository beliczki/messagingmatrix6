...
- **Nyitott a többi termékre:** MC0-tömeg (SZA 134 keyword!), video-only channel (YT később), a 91 nem-LTP Adobe PSD törlés, cross-product szám-ütközés ellenőrzés futásonként. Ismert deferred: nonDCO auto-topicok üres sorként megjelenhetnek a DCO nézetben is (Slice-4 topic-scoping halasztva).
